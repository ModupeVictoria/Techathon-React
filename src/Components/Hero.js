...
function Hero() {
  ...
  return (
    <div className=' bg-[#d5e5f5] '>
        <div className='container flex flex-col-reverse md:flex-row md:justify-between items-center mx-auto'>
            <div className='mt-8'>
             ...
             <h1 className='text-5xl font-bold mb-8 text-[#001d46]'>Your Amazing Pets <br/> are Important to us</h1>
                ...
                <botton className=''>
                <Link to="/register" className="text-white bg-[#3781e2] hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 ">Get Started</Link>
                </botton>
              </div>            
